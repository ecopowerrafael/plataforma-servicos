...
UPDATE `payments` SET `origin_type` = 'APPOINTMENT' WHERE `appointmentId` IS NOT NULL;
UPDATE `payments` SET `origin_type` = 'MEMBERSHIP_CHARGE' WHERE `membershipChargeId` IS NOT NULL;
