...
export function createDatabaseConnection(
  ...
  return {
    ...
    ...(credentialsCipher ? { prospectingWhatsAppConfig: new ProspectingWhatsAppConfigService(client, credentialsCipher, new WApiIntegrationService(wapiCredentialProvider, customerAuthOptions?.wapiBaseUrl), customerAuthOptions?.appWebUrl) } : {}),
    ...
    integrations: new IntegrationService(
      ...
      client,
      credentialsCipher ? new ProspectingWhatsAppConfigService(client, credentialsCipher, new WApiIntegrationService(wapiCredentialProvider, customerAuthOptions?.wapiBaseUrl), customerAuthOptions?.appWebUrl) : undefined,
      environment,
