...
export class AppointmentService {
  ...
  private appointmentStatus(value: string): AppointmentStatus {
    switch (value) {
      case 'PENDING': case 'CONFIRMED': case 'IN_PROGRESS': case 'COMPLETED': case 'CANCELED': case 'NO_SHOW': return value;
      default: throw new AppError({ code: 'APPOINTMENT_STATUS_INVALID', message: 'Status de agendamento inválido.', statusCode: 400 });
    }
  }
