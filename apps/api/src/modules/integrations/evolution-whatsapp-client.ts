...
export class EvolutionWhatsAppClient {
  ...
  public status(instanceToken: string) { return this.request<{ status?: string; state?: string; connected?: boolean; loggedIn?: boolean; connectedPhone?: string; connectedName?: string; phone?: string; number?: string; name?: string; pushName?: string }>('/instance/status', { method: 'GET' }, instanceToken); }
